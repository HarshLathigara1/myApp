package com.harsh.lathigara.tictactoe
...
class MainActivity : AppCompatActivity() {
    ...
    fun imageButtonTapped(view: View){
        ...
        when(randomNumber)
        {
            1 -> tableLayout.setBackgroundColor(Color.BLACK)
            2 -> tableLayout.setBackgroundColor(Color.GREEN)
            3 -> tableLayout.setBackgroundColor(Color.CYAN)
            4 -> tableLayout.setBackgroundColor(Color.LTGRAY)
            5 -> tableLayout.setBackgroundColor(Color.MAGENTA)
            6 -> tableLayout.setBackgroundColor(Color.RED)
            7 -> tableLayout.setBackgroundColor(Color. BLUE)
   ...
   /* private  fun specifyTheWinnerOfGame(){
        if(player1Option.contains(1)
            &&player1Option.contains(2)
            &&player1Option.contains(3)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_ONE
        }else if (player2Option.contains(1)
            &&player2Option.contains(2)
            &&player2Option.contains(3)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_TWO
        }else if(player1Option.contains(4)
            &&player1Option.contains(5)
            &&player1Option.contains(6)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_ONE
        }else if(player2Option.contains(4)
            &&player2Option.contains(5)
            &&player2Option.contains(6)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_TWO
        }else if (player1Option.contains(7)
            &&player1Option.contains(8)
            &&player1Option.contains(9)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_ONE
        }else if (player2Option.contains(7)
            &&player2Option.contains(8)
            &&player2Option.contains(9)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_TWO
        }else if (player1Option.contains(1)
            &&player1Option.contains(4)
            &&player1Option.contains(7)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_ONE
        }else if (player2Option.contains(1)
            &&player2Option.contains(4)
            &&player2Option.contains(7)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_TWO
        }else if (player1Option.contains(2)
            &&player1Option.contains(5)
            &&player1Option.contains(8)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_ONE
        }else if (player2Option.contains(2)
            &&player2Option.contains(5)
            &&player2Option.contains(8)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_TWO
        }else if (player1Option.contains(3)
            &&player1Option.contains(6)
            &&player1Option.contains(9)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_ONE
        }else if (player2Option.contains(3)
            &&player2Option.contains(6)
            &&player2Option.contains(9)){
            winnerOfGame = WINNER_OF_GAME.PLAYER_TWO
        }else if (player1Option.contains(1)
        ...
        if(winnerOfGame == WINNER_OF_GAME.PLAYER_ONE){
            ...
            createAlert("Player One Wins","Conrats",AlertDialog.BUTTON_POSITIVE,"OK",false)
            return
        }else if (winnerOfGame == WINNER_OF_GAME.PLAYER_TWO){
            createAlert("player Two Wins", "Congrutalations To Player 2",AlertDialog.BUTTON_POSITIVE,"OK",false)
            return
   ...
   private fun specifyTheWinnerOfGame() {
       ...
       if (winnerOfGame == WINNER_OF_GAME.PLAYER_ONE) {
           ...
           createAlert("Player One Wins",
               ...
               android.app.AlertDialog.BUTTON_POSITIVE, "OK", false)
           return
    ...
    {
        if(allDisabledImages.size == 9 &&
            winnerOfGame != WINNER_OF_GAME.PLAYER_ONE
            && winnerOfGame!=WINNER_OF_GAME.PLAYER_TWO){

            createAlert("DRAW","NO ONE WINS",AlertDialog.BUTTON_POSITIVE,"Ok",false)
        }
